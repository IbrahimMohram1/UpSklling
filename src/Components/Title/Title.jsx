...
export default function Title({title}) {
  return (
    <div>
      <div className="flex items-center justify-center  py-8 my-5 m-auto overflow-hidden">
      ...
      <h2 className="md:text-5xl text-2xl text-center text-wrap font-bold text-[#5B8DEF]">{title}</h2>
      
     <div className="flex flex-col gap-6 md:ml-12 ml-8">
